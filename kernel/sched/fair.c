 ...
 */
unsigned int sysctl_sched_latency					= 5472375ULL;
unsigned int normalized_sysctl_sched_latency		= 5472375ULL;
 ...
 */
unsigned int sysctl_sched_min_granularity				= 666807ULL;
unsigned int normalized_sysctl_sched_min_granularity	= 666807ULL;
