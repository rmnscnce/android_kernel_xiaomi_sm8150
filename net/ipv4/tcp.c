...
atomic_long_t tcp_memory_allocated __cacheline_aligned_in_smp;	/* Current allocated memory. */
 ...
 */
struct percpu_counter tcp_sockets_allocated __cacheline_aligned_in_smp;
